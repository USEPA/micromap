...
\url{https://www.epa.gov/eco-research/level-iii-and-iv-ecoregions-state}\\
...
Other simplification approaches using  open source or free tools include the online tool MapShaper available here: \\ \url{https://mapshaper.org/}. Both polygon simplification as well as line smoothing (Bezier curves for instance)
...
Technical paper, ESRI, "Automation of Map Generalization: The Cutting-Edge Technology," 1996. It can be found in the White Papers section of ArcOnline at this Internet address: \url{https://content.esri.com/support/whitepapers/ao_/mapgen.pdf}
