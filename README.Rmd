...
Linux: [![Travis-CI Build Status](https://travis-ci.org/fawda123/R-micromap-package-development.svg?branch=development)](https://travis-ci.org/fawda123/R-micromap-package-development) 

Windows: [![AppVeyor Build Status](http://ci.appveyor.com/api/projects/status/github/fawda123/R-micromap-package-development?branch=development)](http://ci.appveyor.com/project/fawda123/R-micromap-package-development)
